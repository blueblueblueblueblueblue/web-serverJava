...
<div class="queryordermain">
	...
	<ul class="orderinfo_ul">
		...
		<li>
			...
			<!-- 立即支付 -->
			<div class="pay_footer" style="position: relative;right:13px;">
				<div>商品金额:<span class="font_bold_green">￥</span><span class="font_bold_green"><%=orderBean.getOtotalbooksprice() %></span></div>
				<div>运费:<span class="font_bold_green">￥</span><span class="font_bold_green"><%=orderBean.getOtotaltransprice() %></span></div>
				<div>实付款:<span class="font_big_bold_green">￥</span><span class="font_big_bold_green"><%=orderBean.getOtotalbooksprice() + orderBean.getOtotaltransprice()%></span></div>
				<a class="settlebtn" href="PayClServlet?dowhat=payOrderLaterOn&Oid=<%=orderBean.getOid()%>">支付</a>
			</div>
