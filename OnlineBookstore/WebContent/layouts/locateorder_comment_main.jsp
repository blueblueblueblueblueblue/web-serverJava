					...
					<table>
						...
						%>
							<tr>
								...
								<%
								if(book.getTstatus() == C.TRADESTATUS_WAITCOMMENT)
								{
									%>
									<td><a rel="facebox" title="评价" href="layouts/comment_facebox.jsp?Oid=<%=orderBean.getOid()%>&Bid=<%=book.getBid() %>" class="greenbutton">评价</a></td>
									<%
								}
								else
								{
